...
class Annotator:
    def __init__(self, movement: Movement, **kwargs):
        """
    ...
    def annotate_frame(self, frame):
        ...
        all_points_in_frame = self.movement.all_points_in_frame(lm_list)
        ...
        if lm_list:
            ...
            per = self.movement.percentage(angles)
